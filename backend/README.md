...
## Project Structure
    ...
    ├── just_n_time_bus_app_37366  # Django project configurations
...
1. Clone this repo and `cd just_n_time_bus_app_37366`
...
2. Clone this repo and `cd just_n_time_bus_app_37366`
